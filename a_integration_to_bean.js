...
//抓包的UA
$.UA = 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 Mobile/15E148 Safari/604.1'
...
async function main() {
      ...
      if ($.jifen>=500) {
              ...
              $.body = `[{"pin":"$cooMrdGatewayUid$","businessNo":"`+ $.businessNo+ `","type":2,"transferNumber":500,"title":"物流积分兑换京豆"}]`;
              await TT() 						


					} else {
			  console.log(`******积分不足500，跳过兑换*********\n`);
  ...
  return new Promise(async resolve => {
    const options = {
      ...
      "headers": {
        ...
        'event-id' : `dcdd219a-c2e1-4cbe-bc99-1ccf74571ac1`,
        'Content-Type' : `application/json;charset=utf-8`,
        'access' : `H5`,
        'sdkversion' : `1.0.7`,
        'forcebot' : `0`,
        'Accept' : `application/json, text/plain, */*`,
        'jexpress-report-time' : `1657763413660`,
        'source-client' : `2`,
        'X-Requested-With' : `XMLHttpRequest`,
        'LOP-DN' : `jingcai.jd.com`,
        'jexpress-trace-id' :
        `b01fd8bb-7268-4508-9620-68f240ad2213`,
